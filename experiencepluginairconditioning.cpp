...
#include "experiencepluginairconditioning.h"
...
NYMEA_LOGGING_CATEGORY(dcAirConditioning, "AirConditioning")

ExperiencePluginAirConditioning::ExperiencePluginAirConditioning()
{

}

void ExperiencePluginAirConditioning::init()
{
